...
| **foundry** | `6441877` | 2026-08-13 | [leekt/foundry](https://github.com/leekt/foundry) — branch `feat/eip8141-frame-opcodes` |
...
| Anything about frame *transaction* execution | Nothing yet — [not implemented](guides/04-foundry.md#what-a-node-still-needs) |
...
| Accounts are tested with `forge`, not against a node | anvil does not yet accept type `0x06` transactions. The opcodes execute for real; the transaction context comes from the `setFrameTx` cheatcode. |
